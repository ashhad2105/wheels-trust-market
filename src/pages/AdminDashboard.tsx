...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-grow pt-16 bg-gray-50 flex relative">
        {/* Sidebar - fixed but now within the flex container */}
        <div 
        ...
        <div 
          ...
          } flex-1 pb-16`} // Added pb-16 to ensure content doesn't get hidden behind footer
        >
          <div className="p-6">
